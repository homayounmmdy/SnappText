...
const SearchBar = () => {
  ...
  return (
    <div id="search-snippets" className="bg-gradient-to-r font-comic-bold from-yellow-200 via-pink-200 to-blue-200 relative rounded-3xl shadow-lg border-4 border-black mb-6 overflow-hidden">
